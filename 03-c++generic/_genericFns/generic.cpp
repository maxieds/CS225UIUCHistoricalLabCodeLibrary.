...
void PrintLastThenFirst::operator()(Name const & item) const
{
...
void PrintFirstThenLast::operator()(Name const & item) const
{
...
int CompareFirst::operator()(Name const & first, Name const & second) const
{
...
//         equal; returns 0 otherwise.
int CompareLast::operator()(Name const & first, Name const & second) const
{
